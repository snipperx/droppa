		...
		<ul class="nav">
			...
			<li class="has-sub">
				...
				<ul class="sub-menu">
					...
					<li><a href="ui_social_buttons.html">Social Buttons<i
			...
			<li class="has-sub active">
				...
				<ul class="sub-menu">
					...
					<li class="active"><a href="form_plugins.html">Form Plugins <i
									class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
					...
					<li><a href="form_summernote.html">Summernote <i class="fa fa-paper-plane text-theme m-l-5"></i></a>
					</li>
					<li><a href="form_dropzone.html">Dropzone <i class="fa fa-paper-plane text-theme m-l-5"></i></a>
					</li>
				</ul>
			</li>
			<li class="has-sub">
			...
			<li class="has-sub">
				...
				<ul class="sub-menu">
					<li><a href="../../frontend/one-page-parallax/index.html" target="_blank">One Page Parallax</a>
					</li>
			...
			<li class="has-sub">
				...
				<ul class="sub-menu">
					...
					<li><a href="../angularjs2/index.html">ANGULAR JS 2 <i
									class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
